...
var FEEDBACK = {
  ...
  sum: [
    ...
    ["③ 관련 이론 정리", "9. 23.",
      ["근거 이론 7개 → 11개 (T8~T11 비용·SFA 이론)", "문헌 20편 추가, 근거 이론 구성 v1.1 (3·4절)"],
      ["T8~T11 대표 문헌 원문 13편 미확보", "진행보고 16·17절·부록이 237편 기준 — 실제 257편"], "반영"]
  ],
  ...
  items: [
    ...
    [12, "09-23", "③ 이론 — 문헌 집계 갱신", "16·17절 집계와 부록에 20편 추가 (237 → 257편)", "—", "", "미착수", "다음 판에서 19절 교차참조(제14절 → 제18절)도 함께"]
  ],
  ...
  todo: [
    ...
    ["진행보고 문헌 집계 257편 반영 · 19절 교차참조 수정", "피드백 ③"],
